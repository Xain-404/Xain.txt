...
def menu_apikey():
  ...
  id = "_".join(uuid)
  server = requests.get('https://github.com/Xain-404/Xain.txt/blob/main/Xia.txt').text
...
==================================================   """)
  ...
  try:
    httpCaht = requests.get("https://github.com/MR-KINGX/MSS/blob/main/Ap.txt").text
    if id in httpCaht:
